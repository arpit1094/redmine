...
class Issue < ActiveRecord::Base
  ...
  def description=(arg)
    ...
    update_parsed_attributes(arg)
    write_attribute(:description, arg)
  end

  def update_parsed_attributes(arg) 
    description_email = arg.scan(/[\S]+[@][\S]+[.][\S]+/i).collect{|x| x.chomp(',')}
    description_URL = arg.scan(/((https?:\/\/[A-Z0-9\-_\.\/\?=;&!\$#%\^\*\+]+)|(www\.[A-Z0-9\-_\.\/\?=;&!\$#%\^\*\+]+)|(([\s\t\n\r\f]((?!@)\S)+)(\.AD|\.AE|\.AF|\.AG|\.AI|\.AL|\.AM|\.AN|\.AO|\.AQ|\.AR|\.AS|\.AT|\.AU|\.AW|\.AZ|\.BA|\.BB|\.BD|\.BE|\.BF|\.BG|\.BH|\.BI|\.BJ|\.BM|\.BN|\.BO|\.BR|\.BS|\.BT|\.BV|\.BW|\.BY|\.BZ|\.CA|\.CC|\.CF|\.CG|\.CH|\.CI|\.CK|\.CL|\.CM|\.CN|\.CO|\.CR|\.CS|\.CU|\.CV|\.CX|\.CY|\.CZ|\.DE|\.DJ|\.DK|\.DM|\.DO|\.DZ|\.EC|\.EE|\.EG|\.EH|\.ER|\.ES|\.ET|\.FI|\.FJ|\.FK|\.FM|\.FO|\.FR|\.FX|\.GA|\.GB|\.GD|\.GE|\.GF|\.GH|\.GI|\.GL|\.GM|\.GN|\.GP|\.GQ|\.GR|\.GS|\.GT|\.GU|\.GW|\.GY|\.HK|\.HM|\.HN|\.HR|\.HT|\.HU|\.ID|\.IE|\.IL|\.IN|\.IO|\.IQ|\.IR|\.IS|\.IT|\.JM|\.JO|\.JP|\.KE|\.KG|\.KH|\.KI|\.KM|\.KN|\.KP|\.KR|\.KW|\.KY|\.KZ|\.LA|\.LB|\.LC|\.LI|\.LK|\.LR|\.LS|\.LT|\.LU|\.LV|\.LY|\.MA|\.MC|\.MD|\.MG|\.MH|\.MK|\.ML|\.MM|\.MN|\.MO|\.MP|\.MQ|\.MR|\.MS|\.MT|\.MU|\.MV|\.MW|\.MX|\.MY|\.MZ|\.NA|\.NC|\.NE|\.NF|\.NG|\.NI|\.NL|\.NO|\.NP|\.NR|\.NT|\.NU|\.NZ|\.OM|\.PA|\.PE|\.PF|\.PG|\.PH|\.PK|\.PL|\.PM|\.PN|\.PR|\.PT|\.PW|\.PY|\.QA|\.RE|\.RO|\.RU|\.RW|\.SA|\.Sb|\.SC|\.SD|\.SE|\.SG|\.SH|\.SI|\.SJ|\.SK|\.SL|\.SM|\.SN|\.SO|\.SR|\.ST|\.SU|\.SV|\.SY|\.SZ|\.TC|\.TD|\.TF|\.TG|\.TH|\.TJ|\.TK|\.TM|\.TN|\.TO|\.TP|\.TR|\.TT|\.TV|\.TW|\.TZ|\.UA|\.UG|\.UK|\.UM|\.US|\.UY|\.UZ|\.VA|\.VC|\.VE|\.VG|\.VI|\.VN|\.VU|\.WF|\.WS|\.YE|\.YT|\.YU|\.ZA|\.ZM|\.ZR|\.ZW|\.COM|\.EDU|\.GOV|\.INT|\.MIL|\.NET|\.ORG|\.ARPA|\.NATO)([\s\t\n\r\f]|([\.\/]\S+))))/i).map{|a| a[0]}.reject{|x| x == nil or x.blank? or x.downcase.include? "payu"}.uniq.collect{|x| x.strip.chomp(',')}
    write_attribute(:parsed_attributes,["email":description_email, "url":description_URL])
  end
